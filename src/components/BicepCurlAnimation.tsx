...
const BicepCurlAnimation = () => {
  ...
  return (
    <svg viewBox="0 0 300 400" className="w-full max-w-[260px] h-auto">
      ...
      <line x1={shoulderX} y1={shoulderY - shoulderOffsetY} x2={elbowX} y2={elbowY} stroke={strokeColor} strokeWidth="4" strokeLinecap="round" />
      <line x1={elbowX} y1={elbowY} x2={wristX} y2={wristY} stroke={strokeColor} strokeWidth="4" strokeLinecap="round" />
